...
python ./Functions/aux_charge_include.py Surface_files/water_equilibrium_calculation/uncharged_prmtop Input/charges_info/CONTCAR_surf_cm5output $1
mv Surface_files/water_equilibrium_calculation/uncharged_prmtop_charged Surface_files/water_equilibrium_calculation/prmtop
