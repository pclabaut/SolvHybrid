...
python ./Functions/aux_charge_include.py Molecule_files/water_equilibrium_calculation/uncharged_prmtop Input/charges_info/CONTCAR_mol_cm5output $1
mv Molecule_files/water_equilibrium_calculation/uncharged_prmtop_charged Molecule_files/water_equilibrium_calculation/prmtop
python ./Functions/aux_charge_include.py Molecule_files/gas_phase_SP/uncharged_prmtop Input/charges_info/CONTCAR_mol_cm5output $1
mv Molecule_files/gas_phase_SP/uncharged_prmtop_charged Molecule_files/gas_phase_SP/prmtop
